...
urlpatterns = [
    ...
    path('<int:pk>/estoque/ajax/', views.produto_stock_adjust_ajax, name='produto-stock-adjust-ajax'),
    ...
    path('categorias/ajax-nova/', views.categoria_create_ajax, name='categoria-create-ajax'),
